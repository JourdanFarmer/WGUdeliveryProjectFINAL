...
import time
import collections
from Package import DeliverySystem
...
def initialize_truck1():
    ...
    truck1.add_package(package_ingest.get_package_by_id('1'), 1)
    truck1.add_package(package_ingest.get_package_by_id('29'), 1)
    truck1.add_package(package_ingest.get_package_by_id('7'), 1)
    truck1.add_package(package_ingest.get_package_by_id('30'), 1)
    truck1.add_package(package_ingest.get_package_by_id('8'), 1)
    truck1.add_package(package_ingest.get_package_by_id('34'),1)
    truck1.add_package(package_ingest.get_package_by_id('40'),1)
    truck1.add_package(package_ingest.get_package_by_id('13'), 1)
    truck1.add_package(package_ingest.get_package_by_id('39'), 1)
    truck1.add_package(package_ingest.get_package_by_id('14'), 1)
    truck1.add_package(package_ingest.get_package_by_id('15'), 1)
    truck1.add_package(package_ingest.get_package_by_id('16'), 1)
    truck1.add_package(package_ingest.get_package_by_id('19'), 1)
    truck1.add_package(package_ingest.get_package_by_id('20'), 1)
    truck1.add_package(package_ingest.get_package_by_id('37'), 1)
...
def initialize_truck1_trip2():
    ...
    truck1_trip2.add_package(package_ingest.get_package_by_id('6'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('5'), 1)

    truck1_trip2.add_package(package_ingest.get_package_by_id('21'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('4'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('24'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('23'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('26'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('22'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('10'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('11'), 1)
    truck1_trip2.add_package(package_ingest.get_package_by_id('31'), 1)
...
def initialize_truck2():
    ...
    truck2.add_package(package_ingest.get_package_by_id('17'), 2)
    truck2.add_package(package_ingest.get_package_by_id('12'), 2)
    truck2.add_package(package_ingest.get_package_by_id('25'), 2)
    truck2.add_package(package_ingest.get_package_by_id('28'), 2)
    truck2.add_package(package_ingest.get_package_by_id('32'), 2)
    truck2.add_package(package_ingest.get_package_by_id('3'), 2)
    truck2.add_package(package_ingest.get_package_by_id('18'), 2)
    truck2.add_package(package_ingest.get_package_by_id('36'), 2)
    truck2.add_package(package_ingest.get_package_by_id('38'), 2)
    truck2.add_package(package_ingest.get_package_by_id('27'), 2)
    truck2.add_package(package_ingest.get_package_by_id('35'),2)
    truck2.add_package(package_ingest.get_package_by_id('2'), 2)
    truck2.add_package(package_ingest.get_package_by_id('33'), 2)
    truck2.add_package(package_ingest.get_package_by_id('9'), 2)
                    ...
                    if (input_choice == "all"):
                        ...
                        for key in sorted_packages:
                            if ("delivered" in str(sorted_packages[key])):
                                package_truck_id = delivery_system.truck_id(key)
                                print("\t"+str(sorted_packages[key]) + "  : delivered by Truck " + package_truck_id)
